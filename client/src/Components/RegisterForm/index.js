        ...
        <>
            <form className="">
                ...
                <div className="mb-3" style={{ backgroundColor: "#F2F2F2" }}>
                    ...
                    <input onChange={props.handleChange} name="phone" value={props.phone} onInput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="text" maxLength="10" className="form-control" id="phoneInput" placeholder="Enter phone number" required />
                </div>
                <div className="mb-3" style={{ backgroundColor: "#F2F2F2" }}>
                ...
                <div className="mb-3">
                    <button style={{ backgroundColor: "#3178c6" }} type="submit" class="btn btn-primary" onClick={props.handleSubmit}>Save</button>
                </div>
            </form>
        </>
    )
